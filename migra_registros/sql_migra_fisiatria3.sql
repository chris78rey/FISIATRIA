/* Formatted on 20/06/2016 7:46:51 (QP5 v5.252.13127.32867) */
...
DECLARE
   CURSOR CURS
   IS
      SELECT 'ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED RENAME TO AA_TABLA_EQUIV_PROCED_X1'
                TEXT
        FROM DUAL;
...
ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED ADD (REVISADO INTEGER DEFAULT 0);
ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED ADD (PROID0NIVEL INTEGER DEFAULT 0);
ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED ADD (PROID1NIVEL INTEGER DEFAULT 0);
ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED ADD (PROID2NIVEL INTEGER DEFAULT 0);
ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED ADD (PES_ID_0 INTEGER);
ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED ADD (PES_ID_1 INTEGER);
ALTER TABLE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED ADD (PES_ID_2 INTEGER);