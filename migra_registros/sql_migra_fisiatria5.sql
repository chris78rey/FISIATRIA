...
REM ELECTROTERAPIA A ELECTR-MECANO
...
REM HIDRO A TERAPIA FISICA HIDROTERAPIA
UPDATE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED
   SET AA_TABLA_EQUIV_PROCED.PROID0NIVEL = 1,
...
REM MECANOTERAPIA GIMNASIO  A ELCTROMECANO
UPDATE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED
   SET AA_TABLA_EQUIV_PROCED.PROID0NIVEL = 1,
       AA_TABLA_EQUIV_PROCED.PROID1NIVEL = 6,
       AA_TABLA_EQUIV_PROCED.REVISADO = 1
...
REM ONDAS DE CHOQUE LASERTERAPIA  --->ONDAS DE CHOQUE ONDAS DE CHO LASERTERAPIS
UPDATE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED
...
REM TERAPIA DE LENGUAJE A TERAPIA DE LENGUAJE
UPDATE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED
...
REM TERAPIA OCUPACIONAL A TERAPIA OCUPACIONAL
UPDATE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED
...
DECLARE
   CURSOR c1
   IS
      SELECT ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED.ROWID,
             V_PROCED_ESPSER_NIVELES.PES_ID_0,
             V_PROCED_ESPSER_NIVELES.PES_ID_1,
             V_PROCED_ESPSER_NIVELES.PES_ID_2
        FROM ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED
             INNER JOIN ADMINISTRATIVO.V_PROCED_ESPSER_NIVELES
                ON     (AA_TABLA_EQUIV_PROCED.PROID2NIVEL =
                           V_PROCED_ESPSER_NIVELES.PRO_ID_2)
                   AND (AA_TABLA_EQUIV_PROCED.PROID1NIVEL =
                           V_PROCED_ESPSER_NIVELES.PRO_ID_1)
                   AND (AA_TABLA_EQUIV_PROCED.PROID0NIVEL =
                           V_PROCED_ESPSER_NIVELES.PRO_ID_0)
       WHERE    V_PROCED_ESPSER_NIVELES.PES_ID_0 IS NOT NULL
             OR V_PROCED_ESPSER_NIVELES.PES_ID_1 IS NOT NULL
             OR V_PROCED_ESPSER_NIVELES.PES_ID_2 IS NOT NULL;
BEGIN
   FOR x IN C1
   LOOP
      UPDATE ADMINISTRATIVO.AA_TABLA_EQUIV_PROCED
         SET AA_TABLA_EQUIV_PROCED.PES_ID_0 = x.PES_ID_0,
             AA_TABLA_EQUIV_PROCED.PES_ID_1 = x.PES_ID_1,
             AA_TABLA_EQUIV_PROCED.PES_ID_2 = x.PES_ID_2
       WHERE AA_TABLA_EQUIV_PROCED.ROWID = x.ROWID;
   END LOOP;
END;
/
